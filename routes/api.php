	...
	Route::group([
		...
		*/
		Route::group(['prefix' => 'labels'], function () {
			...
			Route::get('group/{slug}', 'GroupController@show');
			Route::post('group', 'GroupController@store');
			Route::put('group/{slug}', 'GroupController@update');
			Route::delete('group/{slug}', 'GroupController@destroy');
			/**
			 * Invoice status
			 */
			...
			Route::get('role/{slug}', 'RoleController@show');
			Route::post('role', 'RoleController@store');
			Route::put('role/{slug}', 'RoleController@update');
			Route::delete('role/{slug}', 'RoleController@destroy');
			/**
			 * Subscription status
			 */
